function initPage()
{
	...
	paragraph_text = document.createTextNode(bh_ap_select_question);
	...
	var choices_text = document.createTextNode(bh_ap_select_item_1);
	insertAfter(choices_text, choices[0]);
	
	choices_text = document.createTextNode(bh_ap_select_item_2);
