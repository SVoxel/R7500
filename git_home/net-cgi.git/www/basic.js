...
function basic_menu_class_default()
{
	...
	*/
	...
	if((top.enable_ap_flag== 1 || top.enable_bridge_flag== 1) && top.streamboost_flag == 1)
	{
	...
	if(top.enable_ap_flag== 1 || top.enable_bridge_flag== 1)
	{
		var transmission_div = top.document.getElementById("transmission");
		transmission_div.className = transmission_div.className + "_grey";
	}
...
function click_action(id)
{
		...
		else if( id == "intqos" && top.streamboost_flag == 1 && top.enable_ap_flag != 1 && top.enable_bridge_flag == 0)
		{
			basic_menu_color_change('intqos');
			goto_formframe("QOS_basic.htm");
		}
		...
		else if( id == "transmission" && top.enable_ap_flag != 1 && top.enable_bridge_flag == 0)
                {
                        basic_menu_color_change('transmission');
			goto_formframe('http://routerlogin.net:9091/transmission/web/');
                }
		...
		else if( id == "no_internet" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.broadband_mode != "MyDetc" && top.enable_bridge_flag == 0)
		{
			if(top.have_broadband==1 && (top.is_ru_version==1 || top.is_pr_version==1))
			{
				open_or_close_sub('internet');
