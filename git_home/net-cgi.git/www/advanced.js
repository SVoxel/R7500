...
var wds_ap_items = ["internet", "wan", "block_site", "block_services", "forwarding_triggering","qos","vpn", "dns", "static", "remote", "upnp", "traffic", "wl_bridge"];
var bridge_items = [ "internet", "wireless", "guest","wan", "lan","qos", "parental","access_control","vpn","block_site", "block_services", "email", "schedule","wds","forwarding_triggering", "dns", "static", "remote", "upnp", "traffic", "ipv6", "wlap"];
	...
	if(id == "setup_wizard")
		...
		if( id == "home" )
			...
			menu_color_change('lan');
                ...
                else if( id == "qos" && top.enabled_wds == 0 && top.enable_ap_flag != 1 && top.enable_bridge_flag != 1)
                {
			if(top.streamboost_flag == 1)
			{
				goto_formframe("QOS_advanced.htm");
