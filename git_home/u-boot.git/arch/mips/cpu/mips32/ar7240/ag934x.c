...
#if (CONFIG_COMMANDS & CONFIG_SYS_CMD_MII) || defined(CONFIG_CMD_MII)
#include <miiphy.h>
#endif
...
#ifndef CONFIG_SYS_DUAL_PHY_SUPPORT
...
#endif		/* CONFIG_COMMANDS & CONFIG_SYS_CMD_MII */
